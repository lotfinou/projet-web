    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div>
                    <form method="post" action="eventAjout.php">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="dateModif" id="dateModif" >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="nbPartic">Nombre de participants</label>
                            <input type="number" class="form-control" name="nbPartic">
                        </div>
