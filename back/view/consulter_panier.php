...
foreach($listePanier as $row){
    ...
    $listeOffre=$offre1C->recupereroffre($id_offre);
    foreach($listeOffre as $lo){
  ?>
 ...
 <td style="width="70% ><form method="POST" action="supprimer_panier.php" >
            <input type="submit" name="delete" value="Delete" class="btn btn-danger btn-block" >
                         <input type="hidden" value="<?php echo $row['id']; ?>" name="id" >
                         </form>
                        </td>
                         <td><a class="btn btn-success btn-block" href="modifier_panier.php?id=<?PHP echo $row['id']; ?>">
  Modifier</a></td>     
